...
Default V3 callable
-------------------
src.domain_shift.canonicalizer_v3:canonicalize_image
...
def extract_canonical_image(result: Any) -> Any:
    """
    Extrai somente a imagem canonicalizada do retorno do V3.

    Suporta:
    - ndarray
    - tuple: (canonical_image, metadata, ...)
    - dict
    """
    ...
    if isinstance(result, dict):
        ...
        raise ValueError(
            "Canonicalizer returned a dict but no "
            "canonical image key was found."
        )
