...
ARTIFACTS_DIR = PROJECT_ROOT / "artifacts" / "mlp"
...
def main():
    ...
    x_train = preprocess_mlp(x_train)
    x_test = preprocess_mlp(x_test)
    ...
    with mlflow.start_run(run_name="mlp_baseline") as run:
        ...
        ax.set_title(
            "MLP - Fashion MNIST - Confusion Matrix"
        )
        ...
        history_path = (
            ARTIFACTS_DIR / "training_history.png"
        )
